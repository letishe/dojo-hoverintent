define([
	...
	"dojo/mouse",
	"../main"
], function(kernel, declare, array, lang, dom, on, mouse, dmr){

	//logs message to console that this module is experimental
	kernel.experimental("dmr.mouse.hover");
	//creates dmr.mouse object if it doesn't exist so we can add hover onto it
	lang.getObject("mouse", true, dmr);
	...
	dmr.mouse.hover = new clz();

	dmr.mouse.hover.Hover = clz;

	return dmr.mouse.hover;
});